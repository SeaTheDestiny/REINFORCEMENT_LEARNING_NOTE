...
def QAC_learning(env, num_episodes=NUM_EPISODES):
    """
    Q-Actor-Critic learning loop with history tracking
    
    Algorithm:
    1. Actor: Policy network π(a|s) - outputs action probabilities
    2. Critic: Q-value network Q(s,a) - outputs state-action values
    3. Update rule based on SARSA-style TD error
    """
    ...
    critic = network.CriticNetwork(state_size, action_size)
    ...
    for episode_num in range(num_episodes):
        ...
        for _ in range(MAX_EPISODE_LENGTH):
            ...
            q_values = critic(state_tensor, action_one_hot)
            ...
            with torch.no_grad():
                if done or truncated:
                    ...
                    q_snext_anext = critic(next_state_tensor, next_action_one_hot)
            ...
            actor_loss = -log_pi * q_values.detach()
...
def plot_training_history(rewards, lengths, save_path="images/QAC_LunarLander_training_history.png"):
    """
...
def visualize_policy(actor, env_name='LunarLander-v2', num_episodes=3, output_path='images/QAC_LunarLander_trained_policy.gif'):
    """
...
if __name__ == "__main__":
    ...
    # Start training
    print("Starting QAC training...")
    trained_actor, trained_critic, rewards, lengths = QAC_learning(env, num_episodes=NUM_EPISODES)

    # Plot training curves
    print("Plotting training curves...")
    plot_training_history(rewards, lengths, save_path="images/QAC_LunarLander_training_history.png")

    # Visualize trained policy
    print("Generating policy visualization GIF...")
    visualize_policy(trained_actor, env_name='LunarLander-v2', num_episodes=3, output_path='images/QAC_LunarLander_trained_policy.gif')
